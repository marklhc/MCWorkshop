...
.pull-right[
![](figures/Casino_Monte_Carlo.png)
]
...
- Based on Carsey & Harden (2014):
    ...
    * Simulations help develop intuition
        * Shouldn't replace analytical and theoretical reasoning 
...
knitr::include_graphics("figures/sampdist2.png")
```
...
- What levels? Why?
    ...
    * A small lit review may be needed

---
class: clear, center

```{r, echo=FALSE, out.width='65%'}
knitr::include_graphics("figures/Sigal&Chalmers_figure1.png")
```
...
`r Citet(myBib, "Harwell2018")` for review of design and reporting practices
